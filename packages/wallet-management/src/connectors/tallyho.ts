...
//   constructor(
//     actions: Actions,
//     connectEagerly?: boolean | ConnectEagerlyConfig,
//   ) {
//     super(actions);
...
//     config: ConnectEagerlyConfig = { retries: 5, timeoutMs: 500 },
//   ): Promise<void> {
...
//       throw new Error(
//         "You don't seem to have TallyHo installed because window.tally is not a TallyHo provider.",
//       );
//     }
...
// export const createTallyHoConnector = () => {
//   const [tallyHo, hooks] = initializeConnector<TallyHo>(
//     (actions) => new TallyHo(actions, false),
//   );
//   return { connector: tallyHo, hooks };
// };
