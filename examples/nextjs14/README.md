...
> **_NOTE:_** If you are using Pages Router be sure to look at the examples in `examples/nextjs-page-router` 
> which have been written with Pages Router specifically in mind.
